...
func newTestBackend(t *testing.T, n int, gspec *core.Genesis, engine consensus.Engine, generator func(i int, b *core.BlockGen)) *testBackend {
	...
	gspec.Alloc[acc.Address] = types.Account{Balance: big.NewInt(params.PZX)}
...
func TestEstimateGas(t *testing.T) {
	...
	var (
		...
		genesis  = &core.Genesis{
			...
			Alloc: types.GenesisAlloc{
				accounts[0].addr: {Balance: big.NewInt(params.PZX)},
				accounts[1].addr: {Balance: big.NewInt(params.PZX)},
				accounts[2].addr: {Balance: big.NewInt(params.PZX), Code: append(types.DelegationPrefix, accounts[3].addr.Bytes()...)},
			},
		}
		genBlocks      = 10
	...
	var testSuite = []struct {
		...
		},
		{
			...
			call:        TransactionArgs{},
			overrides: override.StateOverride{
				randomAccounts[0].addr: override.OverrideAccount{Balance: newRPCBalance(new(big.Int).Mul(big.NewInt(1), big.NewInt(params.PZX)))},
			},
			expectErr: nil,
			want:      53000,
		},
	...
	var (
		...
		genesis  = &core.Genesis{
			...
			Alloc: types.GenesisAlloc{
				accounts[0].addr: {Balance: big.NewInt(params.PZX)},
				accounts[1].addr: {Balance: big.NewInt(params.PZX)},
				accounts[2].addr: {Balance: big.NewInt(params.PZX)},
				dad: {
					Balance: big.NewInt(params.PZX),
					Nonce:   1,
	...
	var (
		...
		genesis      = &core.Genesis{
			...
			Alloc: types.GenesisAlloc{
				...
				//     }
				// }
				cac: {Balance: big.NewInt(params.PZX), Code: common.Hex2Bytes("610dad80ff")},
				bab: {
...
func TestSimulateV1ChainLinkage(t *testing.T) {
	var (
		...
		gspec        = &core.Genesis{
			Config: params.MergedTestChainConfig,
			Alloc: types.GenesisAlloc{
				sender:       {Balance: big.NewInt(params.PZX)},
...
func TestSimulateV1TxSender(t *testing.T) {
	var (
		...
		gspec     = &core.Genesis{
			...
			Alloc: types.GenesisAlloc{
				sender:  {Balance: big.NewInt(params.PZX)},
				sender2: {Balance: big.NewInt(params.PZX)},
				sender3: {Balance: big.NewInt(params.PZX)},
			},
		}
		ctx = context.Background()
	)
...
func TestRPCGetBlockOrHeader(t *testing.T) {
	...
	var (
		...
		genesis    = &core.Genesis{
			Config: params.TestChainConfig,
			Alloc: types.GenesisAlloc{
				acc1Addr: {Balance: big.NewInt(params.PZX)},
				acc2Addr: {Balance: big.NewInt(params.PZX)},
			},
		}
		genBlocks = 10
		signer    = types.HomesteadSigner{}
	...
	var (
		...
		genesis    = &core.Genesis{
			...
			Alloc: types.GenesisAlloc{
				...
				//     }
				// }
				contract: {Balance: big.NewInt(params.PZX), Code: common.FromHex("")},
			},
		}
